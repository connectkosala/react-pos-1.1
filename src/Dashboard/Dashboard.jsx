        ...
        <div>
            ...
            <header>
                <nav className='nav-bar'>
                    ...
                    <div className='btn__center'>
                        <Link to='/product'><Button variant="contained" style={{width:'15vh', left: '17vh', top:'13px'}} className='btn1' color='success'>Product</Button></Link>
            ...
            <div>
                <div className='card_1'>
                    <Card sx={{ backgroundColor: '#d1ccc0', height:'27vh'}}>
                        <CardContent>
